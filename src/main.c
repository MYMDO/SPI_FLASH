...
int main(void)
{
    ...
    switch(Flash_Model)
    {
        case W25Q80:
            printf("W25Q80 OK!\r\n");
            strcpy(Model_Flash, "W25Q80");

            break;

        case W25Q16:
            printf("W25Q16 OK!\r\n");
            strcpy(Model_Flash, "W25Q16");

            break;

        case W25Q32:
            printf("W25Q32 OK!\r\n");
            strcpy(Model_Flash, "W25Q32");

            break;

        case W25Q64:
            printf("W25Q64 OK!\r\n");
            strcpy(Model_Flash, "W25Q64");

            break;

        case W25Q128:
            printf("W25Q128 OK!\r\n");
            strcpy(Model_Flash, "W25Q128");

            break;

        default:
            printf("Fail!\r\n");
            strcpy(Model_Flash, "Fail!");

            break;
    }
    printf("Start Erase: %s.... ", (char *)Model_Flash);
    ...
    Delay_Ms(500);
    printf("Start Write: %s.... ", (char *)Model_Flash);
